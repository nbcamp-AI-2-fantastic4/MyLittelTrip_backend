...
class Place(models.Model):
    ...
    typename = models.ForeignKey(PlaceType, verbose_name="장소 유형", on_delete=models.CASCADE)
    
    name = models.CharField("장소 이름", max_length=100, unique=True)
    ...
    image = models.ImageField('장소 이미지', upload_to="static/images/place/%Y%m%d")
